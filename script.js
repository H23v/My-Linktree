document.addEventListener('DOMContentLoaded', () => {
  ...
  // Transizione solo per il salto, non per il cambio src
  ...
  function handleProfileClick() {
    ...
    if (profileClicks === 4) {
      // Al quarto click, cambio immagine definitiva e disabilito ulteriori clic
  ...
  // Sfondo dinamico basato sull'ora
  function setDynamicBackground() {
    const h = new Date().getHours();
    document.body.style.backgroundImage = h >= 17
      ? "url('sfondo/skyboxntt2.jpg')"
      : "url('sfondo/skyboxgrn2.jpg')";
  }
  ...
  function setDefaultLinks() {
    ...
    // Ripristino sfondo dinamico
    setDynamicBackground();
    container.style.opacity = '1';
  }
  setDefaultLinks();

  // Toggle Change (senza fade)
  document.getElementById('changeBtn').onclick = () => {
    ...
    if (isDefault) {
      ...
      document.body.style.backgroundImage = "url('sfondo/skybox3.jpg')";

      // Nascondo b1 e cuoricino
      b1.style.display       = 'none';
      heartLink.style.display= 'none';

      // Aggiorno i restanti bottoni
      b2.textContent = 'PORT_H';      b2.onclick = () => window.open('Portfolio_H.html','_blank');
      b3.textContent = '/*Instagram'; b3.onclick = () => window.open('https://www.instagram.com/tuo_profilo','_blank');
      b4.textContent = '/*Web_Site';  b4.onclick = () => window.open('https://www.tuo-sito.com','_blank');

      // Wave nuovo username
      userEl.textContent = '';
      '@_spacehack_'.split('').forEach((c,i) => {
        const s = document.createElement('span');
        s.textContent = c;
        s.style.animationDelay = `${i*0.1}s`;
        userEl.appendChild(s);
      });
      ...
      subtitle.innerHTML     = 'Media Artist_Net-Art Student_Inhabitant of the Net<br>| Co-founder of HACK |';
      ...
      // Ripristino bottoni e sfondo
      setDefaultLinks();
      userEl.textContent = '';
      '@chiara_bertasini'.split('').forEach((c,i) => {
        const s = document.createElement('span');
        s.textContent = c;
        s.style.animationDelay = `${i*0.1}s`;
        userEl.appendChild(s);
